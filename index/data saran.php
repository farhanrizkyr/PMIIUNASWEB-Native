<?php 
include "coman.php";
$query=mysqli_query($kon,"SELECT*FROM PMII");
error_reporting(0);
...
<br><br><br><br>
<h1 class="text-center"> Data Masukkan Saran Web</h1>
...
<th ><?php echo $s['gmail'] ?></th>
<th ><?php echo $s['saran'] ?> </th>
<th>
     
   <a  href="delete.php?id=<?php echo $s['id'];  ?> " ><img class="potong" src="../index/foto/sampah.png" title="hapus data"></a>
</th>
</tr>
